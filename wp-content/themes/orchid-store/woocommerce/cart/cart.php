        ...
        <thead>
            <tr>
                <th class="product-remove"><span
                        class="screen-reader-text"><?php esc_html_e('Remove item', 'orchid-store'); ?></span></th>
                <th class="product-thumbnail"><span
                        class="screen-reader-text"><?php esc_html_e('Thumbnail image', 'orchid-store'); ?></span></th>
                ...
                <td colspan="6" class="actions">
                    ...
                    <div class="coupon">
                        <label for="coupon_code"
                            class="screen-reader-text"><?php esc_html_e('Coupon:', 'orchid-store'); ?></label> <input
                            type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
                            placeholder="<?php esc_attr_e('Coupon code', 'orchid-store'); ?>" /> <button type="submit"
                            class="button<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>"
                            name="apply_coupon"
                            value="<?php esc_attr_e('Apply coupon', 'orchid-store'); ?>"><?php esc_html_e('Apply coupon', 'orchid-store'); ?></button>
                    ...
                    <button type="submit"
                        class="button<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>"
                        name="update_cart"
                        value="<?php esc_attr_e('Update cart', 'orchid-store'); ?>"><?php esc_html_e('Update cart', 'orchid-store'); ?></button>
        ...
        <form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
            ...
            <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
                <thead>
                    <tr>
                        <th class="product-remove"><span
                                class="screen-reader-text"><?php esc_html_e('Remove item', 'orchid-store'); ?></span>
                        </th>
                        <th class="product-thumbnail"><span
                                class="screen-reader-text"><?php esc_html_e('Thumbnail image', 'orchid-store'); ?></span>
                        </th>
                        <th class="product-name"><?php esc_html_e('Product', 'orchid-store'); ?></th>
                        <th class="product-price"><?php esc_html_e('Price', 'orchid-store'); ?></th>
                        <th class="product-quantity"><?php esc_html_e('Quantity', 'orchid-store'); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" class="actions">
                            ...
                            <div class="coupon">
                                <label for="coupon_code"
                                    class="screen-reader-text"><?php esc_html_e('Coupon:', 'orchid-store'); ?></label>
                                <input type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
                                    placeholder="<?php esc_attr_e('Coupon code', 'orchid-store'); ?>" /> <button
                                    type="submit"
                                    class="button<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>"
                                    name="apply_coupon"
                                    value="<?php esc_attr_e('Apply coupon', 'orchid-store'); ?>"><?php esc_html_e('Apply coupon', 'orchid-store'); ?></button>
